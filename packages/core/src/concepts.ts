...
const STOP_TERMS = new Set([
  'humans', 'animals', 'male', 'female', 'adult', 'aged', 'middle aged', 'young adult',
  'child', 'infant', 'infant, newborn', 'adolescent', 'aged, 80 and over', 'child, preschool',
  'retrospective studies', 'prospective studies', 'treatment outcome', 'risk factors',
  'time factors', 'follow-up studies', 'cohort studies', 'incidence', 'prevalence',
  'united states', 'europe', 'registries', 'hospital mortality', 'survival rate',
